...
you should place your code here."
  ...
  (define-key evil-motion-state-map "f" #'avy-goto-line)
  ...
  (with-eval-after-load 'org
    ...
    (setq org-todo-keywords
          '((sequence "TODO(t)" "INPROCESS(i)" "BLOCKED(b)" "|" "DONE(d)")
